...
<head>
  ...
  <title>Register - Admin PMB SITISIPOL Raja Haji</title>
  ...
  <main class="main">
    ...
    <section id="contact" class="contact section light-background" style="margin-top: 63px;">
      ...
      <div class="container section-title" data-aos="fade-up">
        <span class="description-title">Register</span>
        <h2>Register</h2>
          ...
          <div class="container">
            <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
              <div class="card-body p-4 p-lg-5">
                ...
                <form action="{{ route('postRegister') }}" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="600">
                  @csrf
                  <div class="row gy-4">
