...
<head>
    ...
    <title>Update Data Alur Pendaftaran - Admin PMB SITISIPOL Raja Haji</title>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                               ...
                               <form action="{{ route('updateMegamenuAlurPendaftaranGambar', $alurpendaftaran->id) }}" 
                                      method="POST" 
                                    ...
                                    <div class="row gy-4">
                                         ...
                                         <div class="col-12">
                                            <p>Gambar Saat Ini</p>
                                            <img src="{{ asset('../assets/img/lainnya/pendaftaran/' . $alurpendaftaran->tahap) }}" 
                                                 alt="Gambar Lama" 
                                                 width="200" 
                                                 class="rounded mb-3">
                                            <input type="file" name="tahap" class="form-control">
                                        </div>
