...
<head>
    ...
    <title>Update Data Alur Pendaftaran Gambar - Admin PMB SITISIPOL Raja Haji</title>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                               ...
                               <form action="{{ route('updateMegamenuAlurPendaftaran', $alurpendaftaran->id) }}" 
                                      method="POST" 
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            <p>tahap</p>
                                            <input type="text" name="tahap" 
                                                   value="{{$alurpendaftaran->tahap }}" 
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="deskripsi" 
                                                   value="{{ old('deskripsi', $alurpendaftaran->deskripsi) }}" 
                                                   class="form-control" required>
                                        </div>
                                        ...
                                        <div class="col-12 d-flex justify-content-between align-items-center">
                                            <label>
                                                <input type="checkbox" name="tipe" 
                                                    {{ $alurpendaftaran->background === 'break-card' ? 'checked' : '' }}>
