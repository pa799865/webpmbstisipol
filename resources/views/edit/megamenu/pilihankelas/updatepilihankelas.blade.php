...
<head>
    ...
    <title>Update Data Pilihan Kelas - Admin PMB SITISIPOL Raja Haji</title>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                               ...
                               <form action="{{ route('updateMegamenuPilihanKelas', $pilihankelas->id) }}" 
                                      method="POST" 
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="deskripsi" 
                                                   value="{{ old('deskripsi', $pilihankelas->deskripsi) }}" 
                                                   class="form-control" required>
                                        </div>
