...
<head>
    ...
    <title>Tambah Data Pilihan Kelas - Admin PMB SITISIPOL Raja Haji</title>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form action="{{ route('tambahMegamenuPilihanKelas') }}" method="post" class="php-email-form" enctype="multipart/form-data"
