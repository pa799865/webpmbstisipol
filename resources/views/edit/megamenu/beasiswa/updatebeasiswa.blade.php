...
<head>
    ...
    <title>Update Data Beasiswa - Admin PMB SITISIPOL Raja Haji</title>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                               ...
                               <form action="{{ route('updateMegamenuBeasiswa', $beasiswa->id) }}" 
                                      method="POST" 
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            <p>Tambah Tombol</p>
                                            <input type="text" name="tombol" 
                                            value="{{ old('tombol', $beasiswa->tombol) }}" 
                                        ...
                                        <div class="col-12">
                                            ...
                                            value="{{ old('deskripsi', $beasiswa->deskripsi) }}" 
                                            class="form-control" required>
                                        </div>
                                        
                                        <div class="col-12">
                                            <p>Gambar Saat Ini</p>
                                            <img src="{{ asset('assets/img/beasiswa/' . $beasiswa->img) }}" 
                                                 alt="Gambar Lama" 
                                                 width="200" 
                                                 class="rounded mb-3">
