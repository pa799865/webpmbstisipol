...
<head>
    ...
    <title>Tambah Data Download - Admin PMB SITISIPOL Raja Haji</title>
    ...
    <main class="main">
        ...
        <section id="contact" class="contact section light-background" style="margin-top: 63px;">
            ...
            <div class="container section-title" data-aos="fade-up">
                <span class="description-title">Tambah Konten</span>
                <h2>Tambah Konten</h2>
                <p>Silahkan Tambah konten anda</p>
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form action="{{ route('tambahDownload') }}" method="post" class="php-email-form" enctype="multipart/form-data"
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            <p>Tambah Preview</p>
                                            <input type="text" name="lihat" class="form-control"
                                                placeholder="Masukkan Berupa Link" required>
                                        </div>
                                        <div class="col-12">
                                            <p>Tambah file</p>
