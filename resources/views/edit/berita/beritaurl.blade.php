...
<head>
    ...
    <title>BeritaUrl - Admin PMB SITISIPOL Raja Haji</title>
...
<body class="index-page">
                    ...
                    <div class="container">
                        <div class="contact-form card" data-aos="fade-up" data-aos-delay="300">
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form action="{{ route('updateBeritaurl') }}" method="post" class="php-email-form"
      data-aos="fade-up" data-aos-delay="600" enctype="multipart/form-data">
    @csrf
    <div class="row gy-4">
        @foreach ($beritaUrl as $beritaUrls)
            <div class="berita-item border p-3 mb-3 rounded">
                <input type="hidden" name="beritaurl[{{ $loop->index }}][id]" value="{{ $beritaUrls->id }}">

                <div class="col-12 mb-2">
                    <p>Edit Judul Berita</p>
                    <input type="text"
                           value="{{ $beritaUrls->judul }}"
                           name="beritaurl[{{ $loop->index }}][judul]"
                           class="form-control"
                ...
                <div class="col-12 mb-2">
                    ...
                    <input type="text"
                           value="{{ $beritaUrls->isi }}"
                           name="beritaurl[{{ $loop->index }}][isi]"
                           class="form-control"
                ...
                <div class="col-12 mb-2">
                    <p>Edit Url Berita</p>
                    <input type="text"
                           value="{{ $beritaUrls->url }}"
                           name="beritaurl[{{ $loop->index }}][url]"
                           class="form-control"
                           placeholder="url berita"
                           required>
                </div>

                <button type="button" class="hapusBeritaurl btn btn-danger mt-2">Hapus</button>
            </div>
        @endforeach
    ...
    document.addEventListener("click", function(e) {
        if (e.target.classList.contains("hapusBeritaurl")) {
            e.preventDefault();
            ...
            if (beritaIdInput) {
                ...
                hiddenInput.name = "deleteBeritaurl[]";
