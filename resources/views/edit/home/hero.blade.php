                            ...
                            <div class="card-body p-4 p-lg-5">
                                ...
                                <form action="{{ route('postLogin') }}" method="post" class="php-email-form"
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            <p>Edit Hero Title</p>
                                            <input type="text" name="HomeHeroTitle" class="form-control"
                                        ...
                                        <div class="col-12 ">
                                            ...
                                            <input type="text" class="form-control" name="homeHeroStatNumber"
                                        ...
                                        <div class="col-12 ">
                                            <input type="text" class="form-control" name="homeHeroStatLabel"
                                        ...
                                        <div class="col-12 ">
                                            ...
                                            <input type="text" class="form-control" name="homeHeroFloatingCard"
